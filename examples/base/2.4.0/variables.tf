...
variable "oci_base_operator" {
  ...
  default = { "availability_domain" : 1, "enable_instance_principal" : false, "netnum" : 1, "newbits" : 14, "notification_enabled" : false, "notification_endpoint" : "", "notification_protocol" : "EMAIL", "notification_topic" : "operator", "operating_system_version" : "8", "operator_enabled" : false, "operator_image_id" : "Oracle", "operator_shape" : { "boot_volume_size" : 50, "memory" : 4, "ocpus" : 1, "shape" : "VM.Standard.E3.Flex" }, "operator_state" : "RUNNING", "operator_upgrade" : true, "ssh_private_key_path" : "", "ssh_public_key" : "", "ssh_public_key_path" : "", "tags" : { "role" : "operator" }, "timezone" : "Australia/Sydney" }
}
...
variable "oci_base_vcn" {
  ...
  default = { "create_drg" : false, "drg_display_name" : "drg", "internet_gateway_enabled" : true, "internet_gateway_route_rules" : [], "lockdown_default_seclist" : true, "nat_gateway_enabled" : true, "nat_gateway_public_ip_id" : "none", "nat_gateway_route_rules" : [], "service_gateway_enabled" : true, "tags" : null, "vcn_cidr" : "10.0.0.0/16", "vcn_dns_label" : "", "vcn_name" : "" }
}
