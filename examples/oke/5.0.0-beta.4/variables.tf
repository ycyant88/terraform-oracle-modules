...
variable "nsgs" {
  ...
  default = { "bastion" : {}, "cp" : {}, "fss" : {}, "int_lb" : {}, "operator" : {}, "pods" : {}, "pub_lb" : {}, "workers" : {} }
}
...
variable "subnets" {
  ...
  default = { "bastion" : { "newbits" : 13 }, "cp" : { "newbits" : 13 }, "fss" : { "newbits" : 11 }, "int_lb" : { "newbits" : 11 }, "operator" : { "newbits" : 13 }, "pods" : { "newbits" : 2 }, "pub_lb" : { "newbits" : 11 }, "workers" : { "newbits" : 2 } }
}
