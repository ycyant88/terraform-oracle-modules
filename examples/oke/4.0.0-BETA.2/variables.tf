...
variable "node_pools" {
  ...
  type        = any
  default     = { "np1" : { "boot_volume_size" : 150, "node_pool_size" : 2, "ocpus" : 2, "shape" : "VM.Standard.E4.Flex" }, "np2" : { "boot_volume_size" : 150, "node_pool_size" : 2, "shape" : "VM.Standard.E2.2" }, "np3" : { "node_pool_size" : 1, "shape" : "VM.Standard.E2.2" } }
}
