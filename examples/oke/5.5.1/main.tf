module "oke" {
  ...
  worker_gmc_scale_is_downsize_enabled    = var.worker_gmc_scale_is_downsize_enabled
  worker_gmc_scale_is_upsize_enabled      = var.worker_gmc_scale_is_upsize_enabled
  worker_gmc_scale_target_size            = var.worker_gmc_scale_target_size
