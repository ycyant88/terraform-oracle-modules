...
defined_tags = { "oke" : { "cluster" : {}, "node" : {}, "node_pool" : {}, "persistent_volume" : {}, "service_lb" : {} }, "vcn" : {} }
...
freeform_tags = { "bastion" : { "environment" : "dev", "role" : "bastion" }, "oke" : { "cluster" : { "environment" : "dev" }, "node_pool" : {}, "persistent_volume" : { "environment" : "dev" }, "service_lb" : { "environment" : "dev", "role" : "load balancer" } }, "operator" : { "environment" : "dev", "role" : "operator" }, "vcn" : { "environment" : "dev" } }
...
worker_pool_boot_volume_size = 50

worker_pool_cloudinit = ""

worker_pool_enabled = true

worker_pool_image_id = ""

worker_pool_image_type = "custom"
