...
variable "availability_domains" {
  ...
  type        = map(any)
  default     = { "bastion" : 1, "fss" : 1, "operator" : 1 }
}
...
variable "defined_tags" {
  ...
  default = { "oke" : { "cluster" : {}, "node" : {}, "node_pool" : {}, "persistent_volume" : {}, "service_lb" : {} }, "vcn" : {} }
}
...
variable "freeform_tags" {
  ...
  default = { "bastion" : { "environment" : "dev", "role" : "bastion" }, "oke" : { "cluster" : { "environment" : "dev" }, "node_pool" : {}, "persistent_volume" : { "environment" : "dev" }, "service_lb" : { "environment" : "dev", "role" : "load balancer" } }, "operator" : { "environment" : "dev", "role" : "operator" }, "vcn" : { "environment" : "dev" } }
}
...
variable "subnets" {
  ...
  type        = map(any)
  default     = { "bastion" : { "netnum" : 0, "newbits" : 13 }, "cp" : { "netnum" : 2, "newbits" : 13 }, "fss" : { "netnum" : 18, "newbits" : 11 }, "int_lb" : { "netnum" : 16, "newbits" : 11 }, "operator" : { "netnum" : 1, "newbits" : 13 }, "pods" : { "netnum" : 2, "newbits" : 2 }, "pub_lb" : { "netnum" : 17, "newbits" : 11 }, "workers" : { "netnum" : 1, "newbits" : 2 } }
}
