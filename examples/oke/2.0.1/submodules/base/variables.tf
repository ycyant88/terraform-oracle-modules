...
variable "oci_base_general" {
  ...
  default = { "label_prefix" : "base", "region" : "" }
}
...
variable "oci_base_vcn" {
  ...
  default = { "nat_gateway_enabled" : false, "service_gateway_enabled" : false, "vcn_cidr" : "10.0.0.0/16", "vcn_dns_label" : "base", "vcn_name" : "base" }
}
